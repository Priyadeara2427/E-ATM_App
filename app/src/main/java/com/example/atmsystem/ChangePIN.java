...
public class ChangePIN extends AppCompatActivity {
    private Button changePINButton, HomeButton;
    private TextView OTP_response, resultText;
    private String email, school_name, pet_name, generatedOTP;
    private EditText OTP, old_security_text, new_security_text, school_name_text, pet_name_text;
    private int old_security_pin, new_security_pin, isValidOTP = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Views
        changePINButton = findViewById(R.id.change_pin_page_button);
        ...
        old_security_text = findViewById(R.id.enter_old_security);
        ...
        HomeButton.setOnClickListener(v -> {
            Intent intent = new Intent(ChangePIN.this, Home.class);
