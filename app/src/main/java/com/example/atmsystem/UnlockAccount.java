...
public class UnlockAccount extends AppCompatActivity {
    private Button unlockButton, HomeButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unlock_account_layout);
        ...
        // Initialize Views
        unlockButton = findViewById(R.id.unlock_page_button);
        ...
        school_name_text = findViewById(R.id.enter_school_name_unlock_page);
        pet_name_text = findViewById(R.id.enter_pet_name_unlock_page);
        resultText = findViewById(R.id.unlock_page_response);

        Button verify_otp = findViewById(R.id.verify_otp_button_unlock_page);
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful() && !task.getResult().getDocuments().isEmpty()) {
                            ...
                            if ("Active".equals(status)) {
                                resultText.setText("This account is already active.");
                                ...
                                db.collection("accounts")
                                        ...
                                        .addOnCompleteListener(updateTask -> {
                                            if (updateTask.isSuccessful()) {
                                                resultText.setText("Account is unlocked.");
                                                unlockButton.setVisibility(View.GONE);
                                            } else {
                                                resultText.setText("Failed to unlock account: " + updateTask.getException().getMessage());
                                            }
                                        });
                            } else {
        ...
        HomeButton.setOnClickListener(v -> {
            Intent intent = new Intent(UnlockAccount.this, Home.class);
